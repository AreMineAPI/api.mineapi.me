...
module.exports = (src, W, H, is_slim, overlay) => {
    return loadImage(src).then(async image => {
        ...
        const left_arm_overlay      = await getPart(bufferedCanvas, 960, 832, (is_slim ? 32 : 64), 199, false);
        ...
        const right_leg             = await getPart(bufferedCanvas, 448, 832, 64, 199, false);
        const right_leg_overlay     = await getPart(bufferedCanvas, 192, 832, 64, 199, false);
